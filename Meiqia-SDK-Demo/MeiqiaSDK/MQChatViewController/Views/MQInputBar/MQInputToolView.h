...
@class MQInputToolView;



@protocol MQInputToolViewDelegate<NSObject>

@optional
- (void)inputBar:(MQInputToolView *)inputBar willChangeHeight:(CGFloat)height;
- (void)inputBar:(MQInputToolView *)inputBar didChangeHeight:(CGFloat)height;
...
@interface MQInputToolView : UIView<MQInputContentViewDelegate, MQInputContentViewLayoutDelegate>


@property (weak, nonatomic) id<MQInputToolViewDelegate> delegate;
