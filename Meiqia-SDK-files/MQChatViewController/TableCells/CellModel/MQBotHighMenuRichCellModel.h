...
@interface MQBotHighMenuRichCellModel : NSObject <MQCellModelProtocol>
 ...
 */
- (MQBotHighMenuRichCellModel *)initCellModelWithMessage:(MQBotHighMenuMessage *)message
