...
@class MCKeyboardController;

typedef NS_ENUM(NSInteger, MCKeyboardStatus) {
    MCKeyboardStatusShowing,    //显示状态
    MCKeyboardStatusWillShow,   //即将显示
    MCKeyboardStatusWillHide,   //即将隐藏
    MCKeyboardStatusHide,       //隐藏
};

@protocol MCKeyboardControllerDelegate <NSObject>
...
@interface MCKeyboardController : NSObject

@property (weak, nonatomic) id<MCKeyboardControllerDelegate> delegate;
...
@property (assign, nonatomic) MCKeyboardStatus keyboardStatus;
