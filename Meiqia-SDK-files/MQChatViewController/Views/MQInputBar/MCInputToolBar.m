...
@interface MCInputToolBar ()

@end

@implementation MCInputToolBar
{
...
- (instancetype)initWithFrame:(CGRect)frame contentView:(MCInputContentView *)contentView; {
    if (self = [super initWithFrame:frame]) {
        ...
        _buttonGroupBar = [[MCButtonGroupBar alloc] init];
        ...
        if (!self.contentView) {
            _contentView = [[MCInputContentView alloc] init];
        }
...
-(void)setContentViewDelegate:(id<MCInputContentViewDelegate>)contentViewDelegate
{
    self.contentView.delegate = contentViewDelegate;
}

-(void)setButtonGroupDelegate:(id<MCButtonGroupBarDelegate>)buttonGroupDelegate
{
    self.buttonGroupBar.delegate = buttonGroupDelegate;
}

-(id<MCButtonGroupBarDelegate>)buttonGroupDelegate
{
